...
class Login extends Base
{
    ...
    public function appLogin()
    {
        ...
        $config = [
            'app_id'     => Config::get('miniform.app_id'),
            'app_secret' => Config::get('miniform.app_secret'),
            'scope'      => $scope
        ];
    ...
    public function aliLogin()
    {
        ...
        $alipay = new \addons\miniform\library\alipay\Alipay();
        $result = $alipay->getAuthThird($code, $userinfo);
        $result['__token__'] = $this->request->token();
