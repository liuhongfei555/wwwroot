 ...
 * Ajax控制器
 * Class Ajax
 * @package addons\miniform\controller
 */
class Ajax extends Base
{
    ...
    public function subscribe()
    {
        ...
        $logs_id = $this->request->post('logs_id');
        if(empty($tpl_ids) || empty($logs_id)){
            $this->error('参数错误');
        }
        $ids = \addons\miniform\model\TemplateMsg::getTplIds();
        $data = [];
        ...
        Db::name('miniform_subscribe_log')->insertAll($data);
        $this->success('订阅成功');
    }
